...
\citep[seee.g.][]{,Mortier2013,Torres2012}. The determination of the stellar
...
way using the method described in \citet{Sousa2011}. This in turn allows us to
...
metallicity), and the micro turbulence ($\xi_\mathrm{micro}$). By removing
...
we constrain $\log g$. Last, we change the input [\ion{Fe}/\ion{H}] to match
