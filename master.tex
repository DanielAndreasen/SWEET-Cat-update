...
\hline
\noalign{\medskip} %para dejar mas espacio debajo de la linea
...
%         \tablefoottext{b}{Weighted average of ESPaDoNS and FIES results. The parameters are (FIES in parantheses): $T_\mathrm{eff}=4870(4934)\pm30(29)$
%                                                                                                                    $\log g=2.50(2.73)\pm0.14(0.05)$,
%                                                                                                                    $[\ion{Fe}/\ion{H}]=-0.26(-0.19)\pm0.03(0.02)$, and
%                                                                                                                    $\xi_\mathrm{micro}=1.50(1.59)\pm0.03(0.03)$}
%         \tablefoottext{c}{Weighted average of ESPaDoNS and FIES results. The parameters are (FIES in parantheses): $T_\mathrm{eff}=15124(5121)\pm22(29)$,
