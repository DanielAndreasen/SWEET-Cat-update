...
To date, nearly 3500 extrasolar planets have been discovered around solar-type
...
measure precise values of the radius of a transiting planet \citep[see e.g.][]{,Mortier2013,Torres2012}.
The determination of the stellar radius is in turn dependent on the quality of
the derived stellar atmospheric parameters such as the effective temperature.

We continue the work of \citet{Santos13} by deriving atmospheric parameters,
namely  the effective temperature ($T_\mathrm{eff}$), surface gravity ($\log
g$), metallicity ([Fe/H], where iron often is used as a proxy for the total
...
\citep{FEROS}, and FIES \citep{FIES} spectrographs. Other how many? spectra were
