...
% Aims
% {In this paper we present new precise atmospheric parameters for a sample of 66
% stars with planets. The results are presented in the catalogue: SWEET-Cat.}

% Methods
% {Stellar atmospheric parameters and masses for the 66 stars were derived
...
% Results
% {The stellar parameters for the 66 stars are presented and compared with
...
\ion{Li}{} rich. The \ion{Li}{} abundance we find is in excellent agreement with
\citet{Adamow2014}. Even applying a NLTE correction as done in
\citet{Adamow2014} ($A(\ion{Li}{})_\mathrm{NLTE}=1.08$) this star is not
\ion{Li}{} rich. To understand this star in detail a more detailed abundance
...
\begin{appendix}
\section{Updated parameters of 66 planet hosts}
