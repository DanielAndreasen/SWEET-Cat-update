...
parameters from a set of measured \ion{Fe}{I} and \ion{Fe}{II} line EWs {\bf
...
This is not important for \ion{Fe}{}, so the derived parameters are trustworthy.
...
for \ion{Fe}{}.} The atomic data were calibrated with the Sun as reference and
