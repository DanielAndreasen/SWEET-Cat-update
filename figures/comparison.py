...
if __name__ == '__main__':
    ...
    outliers = ['HAT-P-46', 'HD 120084', 'HD 233604', 'HD 5583', 'HD 81688',
                'HIP 107773', 'WASP-97', 'ome Ser', 'omi UMa']
    ...
    do = df.loc[df['star'].isin(outliers)]
    stat = df.describe()
    ...
    ax1.plot(do.teff, do.teffnew, 'or', alpha=0.7)
    ...
    ax2.plot(do.teff, do.teffdiff, 'or', alpha=0.7)
    ...
    ax3.plot(do.logg, do.loggnew, 'or', alpha=0.7)
    ...
    ax4.plot(do.logg, do.loggdiff, 'or', alpha=0.7)
    ...
    ax5.plot(do.metal, do.fehnew, 'or', alpha=0.7)
    ...
    ax6.plot(do.metal, do.fehdiff, 'or', alpha=0.7)
    ...
    ax7.plot(do.vt, do.vtnew, 'or', alpha=0.7)
    ...
    ax8.plot(do.vt, do.vtdiff, 'or', alpha=0.7)
